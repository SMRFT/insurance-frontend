...
const fetchRecords = async () => {
  ...
  return (
    <ReportContainer>
      <Container>
        <Title>Overall Approval - Gate Pass Issued Records (Final Approval)</Title>
        ...
        <InfoText>
          Showing {records.length} Gate Pass Issued record(s) pending final approval from {fromDate} to {toDate}
        </InfoText>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "40px" }}>
            No Gate Pass Issued records pending final approval for the selected date range
          </div>
        )}
      </Container>
    </ReportContainer>
